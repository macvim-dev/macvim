 ...
 */
    static void
did_set_fullscreen(long old_value)
{
...
#ifdef FEAT_FULLSCREEN
    else if ((int *)varp == &p_fullscreen && (gui.in_use || gui.starting)) // 'fullscreen'
	did_set_fullscreen(old_value);
#endif
#if defined(FEAT_ANTIALIAS) && defined(FEAT_GUI_MACVIM)
    else if ((int *)varp == &p_antialias)	// 'antialias'
	did_set_antialias();
#endif
#if defined(FEAT_GUI_MACVIM)
    else if ((int *)varp == &p_macligatures)	// 'macligatures'
	did_set_macligatures();
    else if ((int*)varp == &p_macthinstrokes)	// 'macthinstrokes'
	did_set_macthinstrokes();
#endif
 ...
 */
    static char *
did_set_transparency(long old_value, char *errmsg)
{
 ...
 */
    static char *
did_set_blur(long old_value, char *errmsg)
{
    if (p_blur < 0)
    {
	errmsg = e_invalid_argument;
...
#endif
#ifdef FEAT_GUI_MACVIM
    else if (pp == &p_columnspace)		// 'columnspace'
	did_set_columnspace();
#endif
#ifdef FEAT_FOLDING
...
#endif
#if defined(FEAT_TRANSPARENCY)
    else if (pp == &p_transp)			// 'transparency'
	errmsg = did_set_transparency(old_value, errmsg);
#endif
#ifdef FEAT_GUI_MACVIM
    else if (pp == &p_blur)			// 'blur'
	errmsg = did_set_blur(old_value, errmsg);
#endif
