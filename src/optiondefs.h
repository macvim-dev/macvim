...
static struct vimoption options[] =
{
    ...
    {"antialias",   "anti", P_BOOL|P_VI_DEF|P_VIM|P_RCLR,
			    ...
			    (char_u *)&p_antialias, PV_NONE, did_set_antialias,
#else
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_blur, PV_NONE, did_set_blur,
#else
			    (char_u *)NULL, PV_NONE, NULL,
#endif
...
# endif
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_columnspace, PV_NONE, did_set_columnspace,
#else
			    (char_u *)NULL, PV_NONE, NULL,
#endif
			    {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    ...
    {"fullscreen",  "fu",   P_BOOL|P_NO_MKRC,
			    ...
			    (char_u *)&p_fullscreen, PV_NONE, did_set_fullscreen,
			    {(char_u *)FALSE, (char_u *)0L}
#else
			    (char_u *)NULL, PV_NONE, NULL,
			    {(char_u *)NULL, (char_u *)0L}
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_macligatures, PV_NONE, did_set_macligatures,
			    {(char_u *)FALSE, (char_u *)0L}
#else
			    (char_u *)NULL, PV_NONE, NULL,
			    {(char_u *)NULL, (char_u *)0L}
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_macthinstrokes, PV_NONE, did_set_macthinstrokes,
			    {(char_u *)FALSE, (char_u *)0L}
#else
			    (char_u *)NULL, PV_NONE, NULL,
			    {(char_u *)NULL, (char_u *)0L}
...
# endif
    ...
    {"transparency",   "transp",  P_NUM|P_VIM|P_RCLR,
			    ...
			    (char_u *)&p_transp, PV_NONE, did_set_transparency,
#else
			    (char_u *)NULL, PV_NONE, NULL,
#endif
			    {(char_u *)0L, (char_u *)0L} SCTX_INIT},
