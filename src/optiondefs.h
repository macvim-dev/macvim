...
static struct vimoption options[] =
{
    ...
    {"antialias",   "anti", P_BOOL|P_VI_DEF|P_VIM|P_RCLR,
			    ...
			    (char_u *)&p_antialias, PV_NONE, did_set_antialias, NULL,
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL
#endif
#ifdef FEAT_GUI_MACVIM
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_blur, PV_NONE, did_set_blur, NULL,
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL,
#endif
...
# endif
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_columnspace, PV_NONE, did_set_columnspace, NULL,
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL,
#endif
			    {(char_u *)0L, (char_u *)0L} SCTX_INIT},
    ...
    {"fullscreen",  "fu",   P_BOOL|P_NO_MKRC,
			    ...
			    (char_u *)&p_fullscreen, PV_NONE, did_set_fullscreen, NULL,
			    {(char_u *)FALSE, (char_u *)0L}
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL,
			    {(char_u *)NULL, (char_u *)0L}
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_mmta, PV_MMTA, NULL, NULL,
			    {(char_u *)FALSE, (char_u *)0L}
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL,
			    {(char_u *)NULL, (char_u *)0L}
...
#ifdef FEAT_GUI_MACVIM
			    (char_u *)&p_macthinstrokes, PV_NONE, did_set_macthinstrokes, NULL,
			    {(char_u *)FALSE, (char_u *)0L}
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL,
			    {(char_u *)NULL, (char_u *)0L}
...
# endif
    ...
    {"transparency",   "transp",  P_NUM|P_VIM|P_RCLR,
			    ...
			    (char_u *)&p_transp, PV_NONE, did_set_transparency, NULL,
#else
			    (char_u *)NULL, PV_NONE, NULL, NULL,
#endif
			    {(char_u *)0L, (char_u *)0L} SCTX_INIT},
