...
// Must be sorted by the 'name.string' field in ascending order because it is used by bsearch()!
{
    ...
    {TRUE, K_FORCECLICK, STRING_INIT("ForceClick"), FALSE},
#endif
...
#ifdef FEAT_GUI_MACVIM
    {TRUE, K_SWIPEDOWN, STRING_INIT("SwipeDown"), FALSE},
    {TRUE, K_SWIPELEFT, STRING_INIT("SwipeLeft"), FALSE},
    {TRUE, K_SWIPERIGHT, STRING_INIT("SwipeRight"), FALSE},
    {TRUE, K_SWIPEUP, STRING_INIT("SwipeUp"), FALSE},
#endif
