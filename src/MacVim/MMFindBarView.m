...
- (void)_buildUI {
    ...
    _nextButton.keyEquivalent = @"\r";  // primary / blue style
    ...
    _matchWordButton = [NSButton checkboxWithTitle:@"Match whole word"
                                            target:nil action:nil];
    _matchWordButton.frame = NSMakeRect(fieldX + 114, y, 150, kFieldH);
